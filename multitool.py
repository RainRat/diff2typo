...
MODE_DETAILS = {
    ...
    "scan": {
        ...
        "flags": "[MAPPING] [FILES...] [-a K:V] [-nS] [-B/A/C N]",
    },
    "verify": {
    ...
    "scrub": {
        ...
        "flags": "[MAPPING] [FILES...] [-a K:V] [-I EXT] [-SD]",
    },
    "align": {
    ...
    "replace": {
        ...
        "flags": "[OLD] [NEW] [FILES...] [-rS] [-I EXT] [-D]",
    },
}
