...
| `--max-length` | None | Ignore words longer than this number of characters. |
...
For better realism, you can load substitution patterns from an external file. This is particularly useful for loading reports generated by `typostats.py`.
