...
def format_typos(typos: Iterable[str], output_format: str) -> List[str]:
    ...
    Args:
        ...
        output_format (str): Desired output format ('arrow', 'csv', 'table', 'list', 'json', 'yaml', 'markdown', 'md', 'html', 'htm').
...
""",
    ...
    io_group.add_argument(
        ...
        dest='output_format',
        type=str,
        choices=['arrow', 'csv', 'table', 'list', 'json', 'yaml', 'markdown', 'md', 'html', 'htm'],
        default=None,
        help='Format of the output typos. If not provided, it is automatically detected from the output file extension. Choices are: arrow (typo -> correction), csv (typo,correction), table (typo = "correction"), list (typo), json, yaml, markdown, md, html, htm. Default is arrow.',
    )
    # Hidden alias for backward compatibility
    parser.add_argument('--output_format', type=str, choices=['arrow', 'csv', 'table', 'list', 'json', 'yaml', 'markdown', 'md', 'html', 'htm'], help=argparse.SUPPRESS, default=argparse.SUPPRESS)
    ...
    if args.output_format is None:
        default_fmt = 'arrow'
        allowed_formats = ['arrow', 'csv', 'table', 'list', 'json', 'yaml', 'markdown', 'md', 'html', 'htm']
