...
def test_should_enable_color_with_env_vars(monkeypatch):
...
def test_should_enable_color_with_stream_isatty():
...
def test_read_file_lines_robust_directory_fallback(tmp_path):
    dir_path = tmp_path / "test_dir"
    dir_path.mkdir()
...
def test_typostats_main_run_as_name(tmp_path):
    import runpy
