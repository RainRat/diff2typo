...
- **`orphans`**
  - Finds files that are not referenced by any Markdown link or image in your project. This is useful for identifying unused assets or incomplete documentation.
